...
class _ActorProfileScreenState extends State<ActorProfileScreen> {
  ...
  Widget build(BuildContext context) {
    if (actorData == null) return const CircularProgressIndicator(); // You can design a loader
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              ...
                              Text("Known for: ${actorData!.knownForDepartment}",
                                  style: const TextStyle(color: Colors.white70)),
                              const SizedBox(height: 6),
                              Text("DOB: ${DateFormat('d MMM, yyyy').format(actorData!.birthday)}, ${actorData!.placeOfBirth}",
                                  style: const TextStyle(color: Colors.white70)),
                              const SizedBox(height: 6),
                              Text("Age: ${DateTime.now().year - actorData!.birthday.year}",
                                  style: const TextStyle(color: Colors.white70)),
                            ],
                          ),
                        ),
